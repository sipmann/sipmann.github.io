...
As versões atuais do Raspbian utilizam o `systemd` para gerenciar os serviços e confesso que nunca havia utilizado o systemctl para nada.
...
Salve o arquivo e vamos rodar um refresh para o SO perceber o novo serviço. Assim rodamos `systemctl daemon-reload`. Sempre que alterarmos um serviço ou criarmos um novo, este comando deve ser executado, caso contrário o próprio systemctl pode lhe alertar da necessidade.
